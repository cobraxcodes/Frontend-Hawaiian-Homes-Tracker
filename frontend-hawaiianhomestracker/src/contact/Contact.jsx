  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg/8 text-gray-600">If you experience any issues submitting your applications or have any other questions, feel free to fill out the form below to reach out to us.
        We're here to help!</p>
      </div>
      <form action="https://formsubmit.co/cobraxcodes@gmail.com" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
